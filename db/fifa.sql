...
CREATE TABLE `edicion_torneos` (
  ...
  `anio` int NOT NULL,
  `sede_final` varchar(350) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `torneos` VALUES (1,'Copa Libertadores','https://logospng.org/download/copa-libertadores/logo-copa-libertadores-256.png',1),(2,'Copa Sudamericana','https://logospng.org/download/copa-sul-americana/logo-conmebol-sul-americana-256.png',1);
...
-- Dump completed on 2024-06-22  9:52:43